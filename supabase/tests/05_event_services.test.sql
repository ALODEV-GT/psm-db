...
select has_column('public', 'event_services', 'service_date', 'event_services has service_date column');
...
select ok(
  ...
  'event_services has an index on service_date'
);
...
values ('77777777-7777-7777-7777-777777777777', '55555555-5555-5555-5555-555555555555', '66666666-6666-6666-6666-666666666666', 'Salon A');

-- Hourly rule (rule 4 + rule 5): service_date/start_time/end_time/price_per_hour
-- required, end_time > start_time, price_per_hour > 0, unit fields must be null.
...
select throws_ok(
  ...
  '23514',
  null,
  'hourly service_type rejected when service_date/start_time/end_time are missing'
);

select throws_ok(
  $$ insert into public.event_services (event_id, service_type, service_date, start_time, end_time, price_per_hour)
     values ('77777777-7777-7777-7777-777777777777', 'fotografias', current_date, '10:00', '09:00', 100) $$,
  '23514',
  null,
...
select throws_ok(
  $$ insert into public.event_services (event_id, service_type, service_date, start_time, end_time, price_per_hour)
     values ('77777777-7777-7777-7777-777777777777', 'fotografias', current_date, '09:00', '10:00', 0) $$,
  '23514',
  null,
...
select throws_ok(
  $$ insert into public.event_services (event_id, service_type, service_date, start_time, end_time, price_per_hour, quantity)
     values ('77777777-7777-7777-7777-777777777777', 'fotografias', current_date, '09:00', '10:00', 100, 2) $$,
  '23514',
  null,
...
select lives_ok(
  $$ insert into public.event_services (event_id, service_type, service_date, start_time, end_time, price_per_hour)
     values ('77777777-7777-7777-7777-777777777777', 'fotografias', current_date, '09:00', '11:00', 100) $$,
  'hourly service_type accepted with a complete, valid set of hourly fields'
);
...
select throws_ok(
  $$ insert into public.event_services (event_id, service_type, service_date, start_time, end_time, price_per_hour)
     values ('77777777-7777-7777-7777-777777777777', 'transmision_en_vivo', current_date, '09:00', '10:00', 200) $$,
  '23514',
  null,
...
select throws_ok(
  $$ insert into public.event_services (event_id, service_type, service_date, start_time, end_time, price_per_hour, visibility)
     values ('77777777-7777-7777-7777-777777777777', 'fotografias', current_date, '09:00', '10:00', 100, 'publico') $$,
  '23514',
  null,
...
select throws_ok(
  $$ insert into public.event_services (event_id, service_type, service_date, start_time, end_time, price_per_hour, stream_title)
     values ('77777777-7777-7777-7777-777777777777', 'fotografias', current_date, '09:00', '10:00', 100, 'Should not be here') $$,
  '23514',
  null,
...
select lives_ok(
  $$ insert into public.event_services (event_id, service_type, service_date, start_time, end_time, price_per_hour, visibility, stream_title, stream_description)
     values ('77777777-7777-7777-7777-777777777777', 'transmision_en_vivo', current_date, '09:00', '12:00', 200, 'publico', 'Wedding stream', 'Live wedding ceremony') $$,
...
values ('88888888-8888-8888-8888-888888888888', '77777777-7777-7777-7777-777777777777', 'fotografias', current_date, '09:00', '11:30', 100);
